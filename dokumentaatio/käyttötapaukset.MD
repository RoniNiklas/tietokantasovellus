...
Fix the length validation and number validation on posting menu items to actually validate and give error messages since the stupid fucking default thing does not do it.  
